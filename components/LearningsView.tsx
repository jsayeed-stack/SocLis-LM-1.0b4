...
const LogicView: React.FC<LogicViewProps> = ({ 
  ...
  const renderEmptyState = () => (
     <div className="flex flex-col items-center justify-center h-full text-brand-text-secondary animate-fade-in p-6 text-center">
        ...
        <h2 className="text-3xl font-bold text-brand-text-primary animate-slide-up-fade" style={{animationDelay: '100ms'}}>Build the AI's Memory</h2>
    ...
    <div className="relative h-full flex flex-col p-6">
        <div className="flex-1 flex flex-col max-w-4xl mx-auto w-full">
            <header className="flex justify-between items-center mb-4">
                <h2 className="text-xl font-bold text-brand-text-primary">Learned Memory</h2>
            ...
            <form onSubmit={handleAddLogic} className="mt-4 flex gap-2">
                <input
                    ...
                    placeholder="Add a new memory point manually..."
